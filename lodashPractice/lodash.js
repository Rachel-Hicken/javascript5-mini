...
//CODE HERE
let allEmail = _.map(customers, 'email');
...
const onlyOne = _.union(inviteList1, inviteList2)
...
const mutualFriends = _.instersection(friendsOfJim, friendsOfBetty)
...
const purCo = _.groupby(purchases, 'company')